...
private:
    ...
    void loadParameters() {
        ...
        nh_.getParam("/line2_right/out_forward", out_forward_);
        nh_.getParam("/line2_right/out_turn", out_turn_);
        ...
        nh_.param("/line2_right/docking_relaxed_yaw_tolerance",
                  docking_relaxed_yaw_tolerance_, 0.08);
        nh_.param("/line2_right/docking_relaxed_hold_time",
                  docking_relaxed_hold_time_, 0.50);
        nh_.param("/line2_right/docking_timeout",
