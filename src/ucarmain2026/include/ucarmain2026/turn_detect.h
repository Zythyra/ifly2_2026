...
#include "ucarmain2026/drConfig.h"
...
public:
    ...
    bool turn_and_find_plus(double find_time,int z,double angular_speed,double& targetx,double& targety,double& targetz,bool& targetflag,double& targetx2,double& targety2,double& targetz2,bool& target2flag,bool& use_forward,bool middle=false);
...
private:
    ...
    ucarmain2026::getpose_server start_get_pose_;

    ros::ServiceClient set_speed_client_;
    ucarmain2026::set_speed set_speed_;

    ros::ServiceClient adjust_client_;
    ucarmain2026::lidar_process board_slope;//lidarprocess客户端
    ucarmain2026::lidar_process avoid_block;

    // dynamic_reconfigure::Server<ucarmain2026::drConfig> server_;//动态参数
