...
def convert_old_model(old_model_dict):
    ...
    epoch = old_model_dict.get("epoch", 0)  # 如果没有 epoch 键，使用默认值 0
    global_step = old_model_dict.get("iter", 0)  # 如果没有 iter 键，使用默认值 0
    state_dict = old_model_dict.get("state_dict", {})
